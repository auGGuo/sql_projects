...
FROM '/Users/augustguo/Desktop/Postgres/practical_sql/pls_fy2014_pupld14a.csv'
...
CREATE INDEX visits2008_idx ON pls_fy2009_pupld09a (visits);

COPY pls_fy2009_pupld09a
FROM '/Users/augustguo/Desktop/Postgres/practical_sql/pls_fy2009_pupld09a.csv'
WITH (FORMAT CSV, HEADER)
...
-- Use group by to eliminate duplicate 
SELECT stabr
FROM pls_fy2014_pupld14a
GROUP BY stabr
ORDER BY stabr;
...
-- Using sum() to Examine Library Visits
